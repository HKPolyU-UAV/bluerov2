...
# Plot x coordinates
axs[0].plot(df_mpc['t'], df_ampc['px_gt'], label='ampc', color='blue', linewidth=4.0)
axs[0].plot(df_mpc['t'], df_mpc['px_gt'], label='mpc', color='orange', linewidth=2.0)
axs[0].plot(df_mpc['t'], df_mpc['px_ref'], label='ref', color='black',linestyle='--', linewidth=4.0)
axs[0].set_ylabel('x (m)')
axs[0].set_ylim([-2.8, 2.8])
axs[0].legend(loc='upper right')

# Plot y coordinates
axs[1].plot(df_mpc['t'], df_ampc['py_gt'], label='ampc', color='blue', linewidth=4.0)
axs[1].plot(df_mpc['t'], df_mpc['py_gt'], label='mpc', color='orange', linewidth=2.0)
axs[1].plot(df_mpc['t'], df_mpc['py_ref'], label='ref', color='black',linestyle='--', linewidth=4.0)
...
# Plot z coordinates
# Plot y coordinates
axs[2].plot(df_mpc['t'], -df_ampc['pz_gt'], label='ampc', color='blue', linewidth=4.0)
axs[2].plot(df_mpc['t'], -df_mpc['pz_gt'], label='mpc', color='orange', linewidth=2.0)
axs[2].plot(df_mpc['t'], -df_mpc['pz_ref'], label='ref', color='black',linestyle='--', linewidth=4.0)
