# UNDER MAINTENANCE!!!
# If you wish to use this repo, please first go to branch ''huyang-backup'' [link](https://github.com/HKPolyU-UAV/bluerov2/tree/huyang-backup); we will soon finish the housekeeping! 
...
4. Install then compile this package
    ```
    cd ~/catkin_ws/src && \
    git clone --branch huyang-back https://github.com/HKPolyU-UAV/bluerov2.git
    ```
