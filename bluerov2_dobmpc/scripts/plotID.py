...
while not rospy.is_shutdown():
    if am_start == True:
        ...
        ax1[0].clear()
        ax1[0].set_ylabel('Xu')
        ax1[0].plot(am_X, label='identified Xu', color='blue')
        ax1[0].axhline(y=1.7182, label='true Xu', color='orange')
        ax1[0].set_ylim([-1, 2])
    ...
    if da_start == True:
        ...
        ax2[0].clear()
        ax2[0].set_ylabel('Xu')
        ax2[0].plot(da_X, label='identified Xu', color='blue')
        ax2[0].axhline(y=-11.7391, label='true Xu', color='orange')
        ax2[0].set_ylim([-15, 5])
