...
def main():
    ...
    # set cost
    # W_x = np.diag([380, 480, 150, 10, 10, 200, 10, 10, 10, 10, 10, 10])    #Q_mat
    W_x = np.diag([300, 480, 200, 10, 10, 200, 10, 10, 10, 10, 10, 10])    #Q_mat
    # W_u = np.diag([15, 15, 0.1, 0.05])                           #R_mat
    W_u = np.diag([1, 1, 0.1, 0.05])                           #R_mat
